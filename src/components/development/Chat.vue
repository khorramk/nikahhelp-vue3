      ...
      <div class="col-12">
        <div class="chat-wrapper">
          <div class="chat-left">
            ...
            <!-- this is r&d purpose -->
            <!-- <div>
              <input type="user_id" v-model="user_id"/>
              <button class="btn btn-primary" @click="loadData">Load Inbox</button>
              <button class="btn btn-primary" @click="loadState">Console State</button>
                <div>
                  <button class="btn btn-primary" @click="createConversations">create conversation</button>
                </div>
            </div> -->
            <!-- this is r&d purpose -->
            ...
            <div class="chat-category">
              ...
              <div class="category-item">
                <!-- <div class="info-button">
                  <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"></button>   
                  <span class="pending-message">12</span> 
            ...
            <div class="chat-item-wrapper">
              <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  <div class="chat-item" v-for="item in recentConversations" :key="item.id" @click="selectConversation(item.id)">
                    <div class="top">
                      <div class="item-img">
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                  <div class="chat-item" v-for="item in teamConversations" :key="item.id" @click="selectConversation(item.id)">
                    <div class="top">
                      <div class="item-img">
                        <img src="../../assets/info-img.png" alt="info image"/>
                        <span></span>
          ...
          <div class="chat-right">
            ...
            <div class="header clearfix">
              <div class="left">
                <div  class="top">
                  ...
                  <div class="chat-info">
                    <div class="chat-name">{{this.getConversationTitle}}</div>
            ...
            <div class="chat-area">
              <div class="chat-box" ref="chatbox" id="chat_box">
                <div v-bind:id="item.id" v-for="item in getMessageList" :key="item.id" v-bind:class="['chats', (item.sent_by === $store.state.user.user.id) ? 'me' : '']">
                  <div class="item-img">
                    <img :src="getUserImage(item.sent_by)" alt="info image"/>
                    <span></span>
                  </div>
                  <div class="message">
                    <p class="msg-text">{{item.msg_text}}</p>
                    <p class="date-time">{{getMsgDate(item.sent_at)}}</p>
                  </div>
                  <!-- <div class="info-button">
                    <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"></button>
                    <div class="dropdown-menu">
...
export default {
  ...
  computed: {
    ...
    teamConversations: function() {
        var teamConversations = [];
        

        if(this.conv_search_key == null || this.conv_search_key == ""){
          for(var i=0;i<this.$store.state.chat.conversations.length; i++){
            if(this.$store.state.chat.conversations[i].type == 'team chat'){
              teamConversations.push(this.$store.state.chat.conversations[i]);
            }
          }
    ...
    returnMsgSendBtnDeactiveStatus(){
      var current_conv = this.$store.state.chat.current_conversation;
      if(this.msg_text == null || this.msg_text == ""){
        return true;
      }
      else{
